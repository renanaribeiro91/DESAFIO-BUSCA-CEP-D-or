...
export declare function makeTypeContentChild({ content, customTypes, required, interfaceOrTypeName, jsDoc }: Omit<TypeContentChild, '__isRoot'>): TypeContentChild;
export declare function makeTypeContentRoot({ joinOperation, interfaceOrTypeName, children, required, jsDoc }: Omit<TypeContentRoot, '__isRoot'>): TypeContentRoot;
/**
